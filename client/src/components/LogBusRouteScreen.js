...
import DisplayBusStopToLog from './DisplayBusStopToLog';
        ...
        return (
            <div>
                ...
                {!dailyRouteInfo.id ? 
                    ...
                    displayedBusStopList.map((busStop)=><DisplayBusStopToLog key = {busStop.id} busStop = {busStop} />): displayedBusStopList.length
                }
